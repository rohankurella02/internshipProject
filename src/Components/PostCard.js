...
function PostCard(props) {
  ...
  return ( 
    ...
    <Card className='mt-3'>
    <div>
    <Card.Img variant="top" src={props.item.profilePic} className="ProfilePic rounded-pill ms-3 mt-2 me-3 border border-3 border-primary"/>   
  ...
  <Card.Img variant="top" src={props.item.photo} style={{ width: '28.8rem', height: '27rem'}}/>
  <Card.Body>
    <div className='text-center border border-1 p-1'>
    <Button variant="light"  className='btnpost'><AiOutlineLike/>Like</Button>
